...
`platforms/fabric/1.0-1.8/bundle/build/libs/mc-auto-translation-tool-fabric-1.0.0-1.8.8-1.3.8.jar`.
...
The verified bundle is written to
`platforms/fabric/1.8-1.12/bundle/build/libs/mc-auto-translation-tool-fabric-1.8.9-1.12.2-1.3.8.jar`.
...
python3 scripts/verify_release_jars.py \
  --checksum-file downloads/1.3.8/SHA256SUMS.txt \
  --require-complete-checksums downloads/1.3.8/*.jar
```
