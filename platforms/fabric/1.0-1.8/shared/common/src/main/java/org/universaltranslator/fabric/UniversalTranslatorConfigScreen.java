...
final class UniversalTranslatorConfigScreen extends Screen {
    ...
    public void init() {
        ...
        blockedKeywords = new TextFieldWidget(renderer, layout.right, layout.row(5),
        ...
        buttons.add(new ButtonWidget(OUTGOING, layout.right, layout.targetY,
                layout.buttonWidth, 20, ""));
        endpoint = new TextFieldWidget(renderer, left, layout.endpointY, layout.buttonWidth, 20);
