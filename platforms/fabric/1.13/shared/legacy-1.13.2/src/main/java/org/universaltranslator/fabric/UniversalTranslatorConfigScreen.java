...
final class UniversalTranslatorConfigScreen extends Screen {
    ...
    void buttonClicked(ButtonWidget button) {
        if (button.id == ENABLED) {
            ...
            if (isLlm()) {
                OrnitheClientAccess.setScreen(new UniversalTranslatorLlmConfigScreen(
            ...
            OrnitheClientAccess.setScreen(new UniversalTranslatorDiagnosticsScreen(this));
            return;
            ...
            OrnitheClientAccess.setScreen(parent);
        }
        refreshLabels();
    }
